...
echo'<br /><button type="submit" class="btn btn-primary">&nbsp;Next</button></form></div>';
echo'<br /><text-a ><button type="submit" class="btn btn-primary"><span class="glyphicon glyphicon-lock" aria-hidden="true"></span>&nbsp;Submit</button></form></div>';
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
		...
		<div class="col-md-4">
		 ...
		 <div class="col-md-5">
		<a href="#" style="color:#202020; font-family:'typo' ; font-size:18px" title="Find on Facebook">Buddhadev Kuila</a>
		<h4 style="color:#202020; font-family:'typo' ;font-size:16px" class="title1">+91 8768189586</h4>
