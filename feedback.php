...
<div class="form-group">
  ...
  <div class="col-md-6">
  <input id="email" name="email" placeholder="Enter your email-id" class="form-control input-md" type="email" require>
...
<div class="col-md-10">
<a href="mailto:buddhadev.hit@gmail.com" style="color:#000000">buddhadev.hit@gmail.com<br /><br />
...
<!-- Text input-->
<div class="form-group">
  <input id="name" name="name" placeholder="Enter your name" class="form-control input-md" type="text" require><br />    
...
<div class="col-md-3 box">
<a href="#" data-toggle="modal" data-target="#developers">Contact Info</a>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" style="font-family:'typo' "><span style="color:orange">Contact Info</span></h4>
      </div>
      ...
      <div class="modal-body">
		...
		<div class="row">
		<div class="col-md-4">
		 <img src="image\Buddha.jpg" width=100 height=100 alt="Buddhadev Kuila" class="img-rounded">
		 </div>
		 <div class="col-md-5">
		<a href="http://yugeshverma.blogspot.in" style="color:#202020; font-family:'typo' ; font-size:18px" title="Find on Facebook">Buddhadev Kuila</a>
		<h4 style="color:#202020; font-family:'typo' ;font-size:16px" class="title1">+91 8967248818</h4>
		<h4 style="font-family:'typo' ">buddhadev.hit@gmail.com</h4>
		<h4 style="font-family:'typo' ">Haldia Institute Of Technology, Haldia</h4></div></div>
		</p>
      </div>
